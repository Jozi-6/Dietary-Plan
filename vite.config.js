...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'GutCheck - Track Your Intake',
        short_name: 'GutCheck',
        description: 'Track your food intake, manage bloating, and achieve a flat stomach through real-time logging and AI feedback.',
        theme_color: '#10b981',
